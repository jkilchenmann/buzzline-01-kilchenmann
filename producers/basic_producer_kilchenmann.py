...
ACTION: list = ["was on a diverted flight", "woke up", "took a wrong turn", "slept while my spouse drove", "went to dinner"]
CITY_1: list = ["Cleveland", "El Paso", "Omaha", "Chicago", "Miami"]
CITY_2: list = ["Pittsburgh", "San Antonio", "Kansas City", "St. Louis", "Tampa"]
